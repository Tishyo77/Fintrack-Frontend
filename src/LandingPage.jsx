...
//             </nav>
//             <div className="content-container">
//                 Shut Up <br></br> & <br></br> Save Your Money
//                 <img src={art} alt="Image" className="art" />
//             </div>
//             <div className="bottom-container">
//                 <div className="text">Navigate your Financial Journey <br></br> with Precision</div>
//                 <div className="overlay"></div>
//             </div>
//             <div className="right-container">
...
//                 <div>
//                     <div className="points">
//                         Track, adapt, and achieve financial success <br></br>
//                         Effortlessly categorize, budget, and excel <br></br>
//                         Visualize your finances, set achievable goals <br></br>
//                     </div>
//                    <Link to="/signup" style={{ textDecoration: 'none' }}>
//                         <button className="center-button">START SAVING NOW!</button>
//                     </Link>
